        ...
        <div className="min-h-screen bg-zinc-50 pt-32 pb-20 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white rounded-[32px] p-8 md:p-12 border border-gray-100 shadow-xl shadow-zinc-200/50">
                    <div className="mb-10">
                        <h1 className="text-3xl font-black text-zinc-900 mb-2">Create New Product</h1>
                        <p className="text-zinc-500 font-medium">List your item on BI Marketplace</p>
                    </div>
                            ...
                            <label className="relative group cursor-pointer block rounded-[24px] overflow-hidden aspect-video bg-zinc-50 border-2 border-dashed border-zinc-200 hover:border-primary-600 transition-all">
                                {imagePreview ? (
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center text-zinc-400 group-hover:text-primary-950 transition-colors">
                                        ...
                                        <p className="text-xs font-medium mt-1">PNG, JPG up to 10MB</p>
                                    </div>
                                )}
                                <input
                                    type="file"
